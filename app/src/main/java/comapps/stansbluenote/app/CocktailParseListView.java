...
public class CocktailParseListView extends Activity {
    // Declare Variables
    ListView listview;
    List<ParseObject> ob;
    ProgressDialog mProgressDialog;
    CocktailParseListViewAdapter adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean hasVisited5 = prefs5.getBoolean("HAS_VISISTED_BEFORE5", false);
        if(!hasVisited5) {



            prefs5.edit().putBoolean("HAS_VISISTED_BEFORE5", true).commit();
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(CocktailParseListView.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            cocktaillist = new ArrayList<CocktailListObject>();
            ...
            try {
                ...
                for (ParseObject stansdata : ob) {
                    ...
                    cocktail.setCocktailName((String) stansdata.get("name"));
                    cocktail.setCocktailIngredients((String) stansdata.get("ingredients"));
                    cocktail.setCocktailPrice((String) stansdata.get("price"));
        ...
        protected void onPostExecute(Void result) {
            ...
            adapter = new CocktailParseListViewAdapter(CocktailParseListView.this,
                    cocktaillist);
    ...
    private class RemoteDataTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(CocktailParseListView.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Stan's Cocktails on Tap");
            // Set progressdialog message
            mProgressDialog.setMessage("Loading...");
            mProgressDialog.setIndeterminate(false);
            // Show progressdialog
