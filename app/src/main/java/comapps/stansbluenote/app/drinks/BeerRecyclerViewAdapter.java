...
public class BeerRecyclerViewAdapter extends RecyclerView.Adapter<BeerRecyclerViewAdapter.ViewHolder> {
    ...
    public BeerRecyclerViewAdapter(List<BeerObject> beerList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.beerlistrowrecyclerview, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(BeerObject beerObject) {
            ...
            beertype.setText(beerObject.getType());
